...
#include "image/common/twain_delegate.h"
...
*/
TwainDelegate::TwainDelegate(HWND hWnd)
{
	m_hTwainDLL = NULL;
	m_pDSMProc = NULL;
...
*/
BOOL TwainDelegate::InitTwain(HWND hWnd)
{
TCHAR libName[512];
	if(IsValidDriver()) 
	{
...
*/
void TwainDelegate::ReleaseTwain()
{
	if(IsValidDriver())
	{
		CloseDSM();
...
*/
BOOL TwainDelegate::IsValidDriver() const
{
...
*
*/
TW_UINT16 TwainDelegate::CallDSMEntry(pTW_IDENTITY pApp, pTW_IDENTITY pSrc,
...
*/
BOOL TwainDelegate::CallTwainProc(pTW_IDENTITY pOrigin,pTW_IDENTITY pDest,
...
derived class
*/
void TwainDelegate::GetIdentity()
{
...
*/
BOOL TwainDelegate::SelectSource()
{
...
*/
BOOL TwainDelegate::SelectDefaultSource()
{
...
*/
BOOL TwainDelegate::DSMOpen() const
{
...
*/
BOOL TwainDelegate::DSOpen() const
{
...
*/
BOOL TwainDelegate::OpenSource(TW_IDENTITY *pSource)
{
	if(pSource) 
	{
		m_Source = *pSource;
...
*/
BOOL TwainDelegate::ProcessMessage(MSG msg)
{
	if(SourceEnabled()){
...
*/
BOOL TwainDelegate::GetCapability(TW_CAPABILITY& twCap,TW_UINT16 cap,TW_UINT16 conType)
{
	if(DSOpen())
	{
		twCap.Cap = cap;
...
Queries the capability of the Twain Data Source
*/
BOOL TwainDelegate::GetCapability(TW_UINT16 cap,TW_UINT32& value)
{
TW_CAPABILITY twCap;
...
*/
BOOL TwainDelegate::SetCapability(TW_UINT16 cap,TW_UINT16 value,BOOL sign)
{
	if(DSOpen())
	{
	TW_CAPABILITY twCap;
...
Sets the capability of the Twain Data Source
*/
BOOL TwainDelegate::SetCapability(TW_CAPABILITY& cap)
{
	if(DSOpen())
	{
...
*/
BOOL TwainDelegate::SetImageCount(TW_INT16 nCount)
{
...
*/
BOOL TwainDelegate::EnableSource(BOOL showUI)
{
...
*/
BOOL TwainDelegate::Acquire(int numImages)
{
...
*/
BOOL TwainDelegate::DisableSource()
{
	if(SourceEnabled())
	{
	TW_USERINTERFACE twUI;
...
*/
void TwainDelegate::TranslateMessage(TW_EVENT& twEvent)
{
...
*/
BOOL TwainDelegate::GetImageInfo(TW_IMAGEINFO& info)
{
	if(SourceEnabled())
	{
...
TWAIN system
*/
void TwainDelegate::TransferImage()
{
TW_IMAGEINFO info;
BOOL bContinue=TRUE;
	while(bContinue)
...
*/
BOOL TwainDelegate::EndTransfer()
{
...
*/
void TwainDelegate::CancelTransfer()
{
TW_PENDINGXFERS twPend;
...
*/
BOOL TwainDelegate::GetImage(TW_IMAGEINFO& info)
{
HANDLE hBitmap;
