...
BEGIN_MESSAGE_MAP(DlgMix, DialogBase)
	//{{AFX_MSG_MAP(DlgMix)
...
void DlgMix::SetMix()
{
	pDocSrc = (CImageDocument*) m_cbSrc.GetItemData(m_cbSrc.GetCurSel());
	pDocDst = (CImageDocument*) m_cbDst.GetItemData(m_cbDst.GetCurSel());
