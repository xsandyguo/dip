...
DlgText::DlgText(CWnd* pParent /*=NULL*/)
	: DialogBase(DlgText::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(DlgText, DialogBase)
	//{{AFX_MSG_MAP(DlgText)
...
{
	HBRUSH hbr = DialogBase::OnCtlColor(pDC, pWnd, nCtlColor);
...
void DlgText::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	...
	DialogBase::OnHScroll(nSBCode, nPos, pScrollBar);
}
