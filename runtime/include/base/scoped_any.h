...
public:
    ...
    pointer_type operator->() const
    {
        ...
        static ::detail::saf_static_assert<!::detail::is_handle<T>::value> const cannot_dereference_a_handle;
        #endif
        assert( valid() );
    ...
    {
        static ::detail::saf_static_assert<!::detail::is_handle<T>::value> const cannot_dereference_a_handle;
        static ::detail::saf_static_assert<!::detail::is_delete<close_policy>::value> const accessed_like_an_array_but_not_deleted_like_an_array;
        assert( valid() );
        return m_t[ i ];
    }
